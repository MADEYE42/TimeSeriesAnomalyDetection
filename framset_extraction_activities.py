...
def extract_frames_from_videos(input_dir, output_dir, interval_sec=0.5):
    # Supported classes
...
if __name__ == "__main__":
    input_video_directory = "VideoDatasetActivities"
    output_frames_directory = "ExtractedFramesActivities"
    extract_frames_from_videos(input_video_directory, output_frames_directory, interval_sec=0.5)
